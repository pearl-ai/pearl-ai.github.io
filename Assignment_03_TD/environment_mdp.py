...
class MDP:
	def __init__(self):
		"""Initialises MDP as a '4-tuple' ==> (S, A, P, R)"""
	...
	def model(self, tg):
		"""Fills the (S, A, P, R) properties of the MDP model using a transition graph"""
	...
	def sample_next_state(self, state_action_pair):
		"""Generates the next state from the given state and action"""
